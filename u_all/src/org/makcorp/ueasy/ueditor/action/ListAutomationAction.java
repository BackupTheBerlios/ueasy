...
public class ListAutomationAction extends HTMLEditorKit.InsertHTMLTextAction
{
	...
	public ListAutomationAction(UEditor ekit, HTML.Tag listType)
	{
		super("", "", listType, HTML.Tag.LI);
		parentEkit = ekit;
		baseTag    = listType;
	}
	...
	public void actionPerformed(ActionEvent ae)
	{
		try
		{
			...
			if(selTextBase == null || textLength < 1)
			{
				...
				insertHTML(jepEditor, htmlDoc, jepEditor.getCaretPosition(), sbNew.toString(), 1, 1, null);
			}
			else {
				String sListType = (baseTag == HTML.Tag.OL ? "ol" : "ul");
				HTMLDocument htmlDoc = (HTMLDocument)(jepEditor.getDocument());
		...
		{
			SimpleInfoDialog sidWarn = new SimpleInfoDialog(parentEkit.getFrame(), "", true, Translatrix.getTranslationString("ErrorCannotConvertToList"));
		}
	}
}
